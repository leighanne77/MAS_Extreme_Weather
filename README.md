...
<!-- BEGIN:system  (generated by readme_build.py — edit readme_assets/system_diagram.mmd or examples/, not here) -->
## 🗺 System at a Glance
...
Public, illustrative: priced physical risk, nature-based-first mitigations, benefit–cost as the referee. Click through to the full pages.

[![Resilience Brief — The Economy Runs on Exposed Ground, with the Port of Mobile worked example](examples/resilience_brief.png)](examples/resilience_brief.html)
<!-- END:system -->
