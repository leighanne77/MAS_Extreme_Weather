...
class A2APart:
    ...
    def get_content_as_dict(self) -> dict[str, Any] | None:
...
def create_text_part(content: str, part_id: str | None = None) -> A2APart:
    """Create a text part."""
    import uuid
    return A2APart(
...
def create_data_part(content: dict[str, Any], part_id: str | None = None) -> A2APart:
    """Create a data part."""
    import uuid
    return A2APart(
        id=part_id or str(uuid.uuid4()),
