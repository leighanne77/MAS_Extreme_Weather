...
class A2AMultiPartMessage(A2AMessage):
    ...
    def add_text_part(self, content: str, part_id: str | None = None) -> A2APart:
    ...
    def add_data_part(self, content: dict[str, Any], part_id: str | None = None) -> A2APart:
    ...
    def add_file_part(self, file_path: str, part_id: str | None = None) -> A2APart:
    ...
    def add_binary_part(self, content: bytes, content_type: str = "application/octet-stream", part_id: str | None = None) -> A2APart:
    ...
    def get_part(self, part_id: str) -> A2APart | None:
        """Get a part by ID."""
    ...
    def get_main_content(self) -> str | dict[str, Any] | None:
