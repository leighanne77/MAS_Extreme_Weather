...
IMPORTANT: Many data integrations require API keys or credentials.
- See credentials_template.txt for a full list of required API keys.
- You must set these as environment variables or in your .env file for live data access.
- Example keys: NASA_EARTHDATA_TOKEN, NOAA_API_KEY, USGS_API_KEY, FRED_API_KEY, EPA_API_KEY, GOOGLE_API_KEY, etc.
- Some features will not work without valid credentials.
"""
...
def main():
    ...
    try:
        ...
        print("3. Configure credentials: Copy credentials_template.txt to .env and fill in all required API keys (see comments in the template)")
        print("   - Required for live data: NASA_EARTHDATA_TOKEN, NOAA_API_KEY, USGS_API_KEY, FRED_API_KEY, EPA_API_KEY, GOOGLE_API_KEY, etc.")
        print("4. Run web interface: python src/tool_web/interface.py")
        print("5. Open browser to: http://localhost:8000")
        print("6. Select user type and start analyzing!")
        
        print("\n📚 Documentation:")
        print("  - User Stories: docs/1-PRODUCT/USER_STORIES_JOURNEYS_and_UX_NEEDS/")
        print("  - System Description: docs/5-ENGINEERING/2.2_System_and_architecture_overview.md")
        print("  - Terms and Definitions: docs/a_PROJECT_STRUCTURE_and_TERMS_Used/0_Terms_used.md")
        print("  - Do Not Do Guidelines: docs/_Cursor/1.3_System_Do_Not_Dos.md")
