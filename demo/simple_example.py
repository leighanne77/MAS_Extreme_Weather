...
from multi_agent_system.risk_definitions import RiskLevel, RiskThreshold  # Updated import
...
def simulate_risk_analysis():
    ...
    # Example: Use a risk definition from the module
    print("\nRisk Level Example from risk_definitions.py:")
    try:
        example_risk = RiskLevel(name="High", description="High hurricane risk")
        print(f"Risk Level: {example_risk.name} - {example_risk.description}")
    except Exception as e:
        print(f"Could not load risk definitions: {e}")
