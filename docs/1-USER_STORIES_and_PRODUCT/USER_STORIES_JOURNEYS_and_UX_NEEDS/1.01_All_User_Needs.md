...
The system serves these six user types:

Capital Asset Managers

1. **Private Equity Investors** - Asset protection and ROI analysis 
2. **Private Debt Managers** - Can be from private equity firms offering this service
3. **Government Funders** - Including Federal/central and local and examples include rural development officers, district collectors, disaster response managers

Data Providers to Capital Asset Managers

These main types of data providers plus hundreds of data sources
4. **Scientific Experts**: Which includes scientists, and relevant large non-governmental organizations and we have an example in 0.610
5. **Local Experts**: These are local groups, including citizen science groups, and local non-profits, scientists and other academics
6. **Indigenous Experts**: Those local knowledge holders who are reviewed/nominated, and this includes indigenous experts and we have an example in 0.611

Below are The First of All Users, User Requirements
...
- **FR1.6**: The system shall provide "Opportunity Benefits" that show how EBITA estimates are better if compared to assets w/o mitigations (experiencing similar extreme heat, more storms) due to lower Opex and Capex costs for energy/cooling and water, compared to similar assets, due to better/faster freshwater recharge photosensitive lights, etc. 
...
- **FR3.6**: System shall support due diligence workflows by providing risk assessment data and analysis tools without requiring access to user's proprietary deal terms or financial calculations
- **FR3.7**: System shall enable users to cross-reference their own plans and data with global data, local data, local experts, and scientists while maintaining complete privacy of user's work and data
- **FR3.8**: System shall allow users to use their own data to finalize plans for use in deal terms without Pythia accessing or viewing their proprietary work
...
- **SEC-1.7**: System shall ensure complete privacy of user's proprietary work, deal terms, and financial calculations - Pythia shall not access, view, or store user's private data or work products
- **SEC-1.8**: System shall provide secure data isolation allowing users to cross-reference external data sources (global data, local data, experts, scientists) without exposing their proprietary information
...
### **December 12, 2025**
- **Private Equity User Privacy Requirements**: Added FR3.6-FR3.8 to support due diligence workflows with complete privacy protection
  - **FR3.6**: System supports due diligence workflows without requiring access to user's proprietary deal terms or financial calculations
  - **FR3.7**: System enables cross-referencing user plans with global/local data, experts, and scientists while maintaining complete privacy
  - **FR3.8**: System allows users to use their own data to finalize plans for deal terms without Pythia accessing proprietary work
- **Enhanced Security Requirements**: Added SEC-1.7 and SEC-1.8 for complete privacy protection of user's proprietary work and secure data isolation for cross-referencing external sources
- **User Requirement Source**: Requirements extracted from Private Equity user needs: "For my use, Pythia will help me with my due diligence work but I want to use my own data to finalize plans for use in deal terms, and I don't want Pythia to see my work then I want to cross-reference my plans with global + local data, and local experts + scientists but again keep my work and data private"
...
- **User Stories Integration**: Integrated comprehensive user needs from [1.2_user_stories_to_review.md](./1.2_user_stories_to_review.md) user stories
