...
- [00_LLM_General_Rules_for_Pythia.md](../../_Cursor/00_LLM_General_Rules_for_Pythia.md) - Guidelines for system constraints and what not to do in this project (primary reference)
- [1.3_System_DNU.md](../../_Cursor/1.3_System_DNU.md) - Legacy/archived file for historical reference only 
