...
```
docs/
├── b_CHANGE_LOG/  # Change log and project documentation directory
│   ├── 00_CHANGELOG.md  # Main changelog file
│   ├── 00_Pythia_Project_Structure.md  # Project structure documentation
│   ├── 00_LLM_General_Rules_for_Pythia.md  # Project restrictions and guidelines (primary reference)
│   └── 00_CHANGELOG_details/  # Detailed changelog documentation
├── 0.2_Prototypes_table.md         # Prototypes table documentation
├── 0.4_DRAFT_DNU_user_personas.md  # User persona definitions
├── 3-EXPERIMENTS/  # Prototype experiments directory
│   ├── 0.6_Alabama/  # Alabama prototype experiments
│   ├── 0.7_india/    # India prototype experiments
│   └── 0.8_archived_prototypes/  # Archived prototype experiments
├── 5-ENGINEERING/  # Engineering documentation directory
│   ├── 1.0_ENG DNU.md  # Engineering documentation (Do Not Use)
│   ├── A2A_ADK/  # A2A and ADK documentation directory
│   │   ├── 2.3_A2A_ADK_Rational.md  # A2A and ADK rationale
│   │   ├── 2.4_Agentcard_Definition_Doc_Tool_Instructions.md  # Agent card special definitions
...
│   ├── DEVOPS/  # DevOps documentation directory
│   │   └── DRAFT_DEVOPS_Plan.md  # DevOps engineering documentation and deployment strategies
│   ├── FRONT_END/  # Frontend documentation directory
│   │   └── Front_end_decisions_explainations.md  # Frontend decision explanations
│   ├── CLOUD/  # Cloud infrastructure documentation directory
│   │   └── GCP_LEVERAGED_BY_PYTHIA.md  # GCP services leveraged by Pythia
│   ├── 2.1_Technical_PRD.md  # Technical PRD with UX integration
│   ├── 2.2_System_and_architecture_overview.md  # System architecture overview
│   ├── 2.8_Engineering_Roadmap.md  # Engineering roadmap with implementation phases
│   └── 2.9_Engineering_Success_metrics.md  # Comprehensive engineering success metrics and KPIs
├── _RULES_Pythia_System_Rules/  # Pythia system rules and constraints
│   ├── 00_LLM_General_Rules_for_Pythia.md  # Primary system constraints and guidelines
│   └── ARCHIVE/
│       └── 1.3_System_DNU.md  # Project restrictions and guidelines (legacy/archived)
├── 1-USER_STORIES_and_PRODUCT/  # User stories and product documentation directory
│   ├── Product_Roadmap_Outcome_Based.md  # Product roadmap with outcome-based planning
│   ├── AGENT/  # Agent requirements and guidelines directory
│   │   └── Agents_Req_for_Pythia.md  # Agent requirements and guidelines
│   ├── PRD/  # Product Requirements Documentation directory
│   │   └── 2.1_Technical_PRD_Pythia_UX_Flow_Diagram.md  # UX flow diagram and implementation status
│   └── USER_STORIES_JOURNEYS_and_UX_NEEDS/  # User stories, journeys, and UX needs directory
│       ├── 1.01_All_User_Needs.md     # Comprehensive user needs documentation
│       ├── 1.1_pythia_all_types_of_users_all_prototypes_user_stories_and_journeys.md  # All user types and needs across all prototypes
│       ├── 1.2_user_stories_to_review.md  # User stories to review and integrate
│       ├── 1.3_pythia_ux_needs_all_users.md  # UX requirements and specifications for all users
│       └── 1.4_More_UX_to_Consider.md  # Additional UX considerations and filters
├── 4-TECH_MONKEYS/  # Technical implementation details
│   └── 3.1_Downscaling_Plan_and_Options.md  # Downscaling plan and options
├── 2.5_small_future_feature_notification.md.md  # Future feature notifications
├── 2-DATA/  # Data sources documentation directory
│   └── 4.1_First_Data_Sources.md  # Comprehensive data sources documentation
├── TODO/  # TODO items and tasks directory
│   ├── (4.1_todo_MCP_servers_to_integrate.md - content consolidated into to_dos_Dec2025.md)
│   └── to_dos_Dec2025.md  # December 2025 TODO items
├── 0_PROJECT_STRUCTURE_and_TERMS_Used/  # Project structure and terms documentation
│   ├── 0_Pythia_Project_Structure.md  # Project structure documentation
